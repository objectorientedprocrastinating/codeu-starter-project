...
public class MapServlet extends HttpServlet {
 ...
 public void init() {
  ...
  Gson gson = new Gson();
  Scanner scanner = new Scanner(getServletContext().getResourceAsStream("/WEB-INF/bus_stops.csv"));
 ...
 private static class BusStop{
  ...
  /**
   * Construct a bus stop with the neighborhood where the bus stop is located and latitude and longitude of it.
   */
